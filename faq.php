...
<head>
  ...
  <style>
    body {
      ...
      margin: 40px;
      background: linear-gradient(to right, #1c1c1c, #4b585c, #2c5364);
      color: #333;
    }
    h1 {
      text-align: center;
...
<body>
  ...
  <div class="faq-container">
    <div class="faq-item">
      <div class="faq-question">masalah pembayaran</div>
      <div class="faq-answer">bagaimana jika pembayaran eror atau tidak dapat di lakukan</div>
    </div>

    <div class="faq-item">
      <div class="faq-question">Bagaimana cara menghubungi tim dukungan?</div>
      <div class="faq-answer">Anda bisa menghubungi kami melalui email di kelompok1@gmail.com atau melalui formulir kontak di halaman "Hubungi Kami".</div>
    </div>

    <div class="faq-item">
      <div class="faq-question">langkah-langkah transaksi</div>
      <div class="faq-answer">pilih game masukkan id game kamu pilih jumlah topup pilih pembayaran, jika transaksi berhasil maka akan mendapatkan riwayat transaksi.</div>
    </div>

    <div class="faq-item">
      <div class="faq-question">Bagaimana cara membuat akun akun?</div>
      <div class="faq-answer">Klik tombol "Daftar" di pojok kanan atas, isi formulir pendaftaran, dan ikuti instruksi selanjutnya.</div>
    </div>
  </div>
...
<body>
    ...
    <header>
        <h1 class="fade-in">Notifikasi Anda</h1>
        <nav>
