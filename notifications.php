    ...
    <main class="fade-in">
        <section class="notifications-section">
            ...
            <?php if (empty($notifications)): ?>
                <p class="no-records">Anda belum memiliki notifikasi.</p>
            <?php else: ?>
                <div class="notification-list">
                    <?php foreach ($notifications as $notification): ?>
                        <div class="notification-item <?php echo $notification['is_read'] ? 'read' : 'unread'; ?>" data-notification-id="<?php echo $notification['id']; ?>">
                            ...
                            <small>Dikirim pada: <?php echo date('d/m/Y H:i', strtotime($notification['created_at'])); ?></small>
                            <?php if (!$notification['is_read']): ?>
                                <button class="notification-mark-read-btn">Tandai Sudah Dibaca</button>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                </div>
